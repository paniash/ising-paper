...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{lsq_Lattice_score-vs-datapts.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{J_2atoms_2.png}
    \caption{J matrix defined for a next nearest interaction lattice}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{J_2atoms_2_ridge.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.7]{beta1-monte.png}
    \caption{Ordered lattice generation}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.7]{beta-5-monte.png}
    \caption{Critical lattice generation}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.7]{beta-1-monte.png}
